...
def main():
    parser = OptionParser()
    parser.add_option('-q','--quiet',dest='quiet',action='store_true',default=False,help='no output in terminal')
    parser.add_option('-i','--input',dest='input_file',help='file for input')
    parser.add_option('-u','--summary',dest='summary',action='store_true',help='generate summary',default=False)
    parser.add_option('-s','--save',dest='save',help='specify save file(without extension)',default='checkpoint')
    parser.add_option('-g','--generate',dest='generate',help='generate data',action='store_true',default=False)
